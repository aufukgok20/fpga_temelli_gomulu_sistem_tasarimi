...
HD_PWD='D:/GIT/fpga_temelli_gomulu_sistem_tasarimi/fpga_odev2_2/fpga_odev2_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Matrix.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Matrix.tcl -notrace
